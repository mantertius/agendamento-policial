(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,85698,e=>{e.v({name:"agendamento-policial",version:"0.1.0",private:!0,scripts:{dev:"next dev",build:"next build",start:"next start",lint:"eslint"},dependencies:{"better-sqlite3":"^12.4.6",next:"16.0.5",nodemailer:"^7.0.11",react:"19.2.0","react-dom":"19.2.0",sharp:"^0.34.5"},devDependencies:{"@tailwindcss/postcss":"^4","@testing-library/dom":"^10.4.1","@testing-library/jest-dom":"^6.9.1","@testing-library/react":"^16.3.0","@types/better-sqlite3":"^7.6.13","@types/jest":"^30.0.0","@types/node":"^20","@types/nodemailer":"^7.0.4","@types/react":"^19","@types/react-dom":"^19","baseline-browser-mapping":"^2.9.4",eslint:"^9","eslint-config-next":"16.0.5",jest:"^30.2.0","jest-environment-jsdom":"^30.2.0","node-mocks-http":"^1.17.2",tailwindcss:"^4","ts-jest":"^29.4.6","ts-node":"^10.9.2",typescript:"^5"}})},73835,e=>{"use strict";e.i(55389);var s=e.i(71811),t=e.i(65029),a=e.i(94300);function r({slot:e,onClose:r}){let{addBooking:l}=(0,a.useApp)(),[o,n]=(0,t.useState)(""),[i,d]=(0,t.useState)(""),[c,m]=(0,t.useState)(""),[x,p]=(0,t.useState)(""),[g,h]=(0,t.useState)(""),[u,b]=(0,t.useState)(!1),[f,v]=(0,t.useState)(""),[j,y]=(0,t.useState)(null),[N,w]=(0,t.useState)(null),k="(82) 3315-7917",C="Av. Norma Pimentel Costa s/nº, Benedito Bentes, Maceió - Alagoas",$="8dp@pc.al.gov.br",D=async e=>{try{w("pending");let s=await fetch("/api/send-email",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:e.email,subject:`Confirma\xe7\xe3o de Agendamento - ${T(e.date)} \xe0s ${e.startTime}`,html:`
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8">
        ...
        <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="margin-top: 40px; text-align: center; color: #666; font-size: 12px; border-top: 1px solid #ddd; padding-top: 20px;">
            <p style="margin-bottom: 10px;"><strong>📍 Endere\xe7o:</strong> ${C}</p>
            <p><strong>📞 Telefone:</strong> ${k} | <strong>📧 E-mail:</strong> ${$}</p>
