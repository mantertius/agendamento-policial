...
"[project]/OneDrive/Desktop/Programming/agendamento-policial/app/api/configs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Programming$2f$agendamento$2d$policial$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(formattedConfigs);
    } catch (error) {
...
async function POST(request) {
    try {
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(config.id, config.startDate, config.endDate, config.startTime, config.endTime, config.slotDuration, JSON.stringify(config.daysOfWeek), config.lunchBreakEnabled ? 1 : 0, config.lunchBreakStart || null, config.lunchBreakDuration || null);
        return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Programming$2f$agendamento$2d$policial$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            config
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6d18f00a._.js.map